  ...
  return (
    <Layout id={'footer'} articleClass="flex-col w-full">
      <footer className="relative flex flex-col items-center justify-center text-slate-400">
        <div className="grid w-full grid-cols-3 items-center justify-center  border-[#333]/10 sm:grid-cols-4">
          {socialMedia.map((media) => {
            return (
              <a
                ...
                border-[#333]/10 text-sm font-medium duration-500 hover:bg-slate-600/10 sm:gap-4 sm:text-xl"
              >
                {media.img != '' && (
                  <img
                    src={media.img}
